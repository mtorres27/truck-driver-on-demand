...
ActiveRecord::Schema.define(version: 20_191_004_174_230) do
  ...
  create_table 'identities', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[loginable_type loginable_id], name: 'index_identities_on_loginable_type_and_loginable_id'
    t.index %w[loginable_type provider uid], name: 'index_identities_on_loginable_type_and_provider_and_uid', unique: true
  end
  ...
  create_table 'messages', force: :cascade do |t|
    ...
    t.bigint 'job_id'
    t.index %w[authorable_type authorable_id], name: 'index_messages_on_authorable_type_and_authorable_id'
    t.index ['job_id'], name: 'index_messages_on_job_id'
    t.index %w[receivable_type receivable_id], name: 'index_messages_on_receivable_type_and_receivable_id'
  end
  ...
  create_table 'notifications', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[authorable_type authorable_id], name: 'index_notifications_on_authorable_type_and_authorable_id'
    t.index %w[receivable_type receivable_id], name: 'index_notifications_on_receivable_type_and_receivable_id'
  end
